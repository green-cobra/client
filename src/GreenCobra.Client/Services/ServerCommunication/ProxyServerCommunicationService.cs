...
//
// public class ProxyServerCommunicationService
// {
//     private readonly LoggerAdapter _logger;
//     public ProxyServerCommunicationService(LoggerAdapter logger)
//     {
//         Guard.AgainstNull(logger);
//         _logger = logger;
//     }
//     
//     public async Task<ProxyServerConfigurationDto> GetProxyConfigurationAsync(
...
//
//         var url = new Uri("http://localhost:777/api/v1/tunnel");
//         var response = await httpClient.PostAsync(url, cancellationToken);
//         
